...
uint256 hashGenesisBlock("0x054b442d8e114a66febb3c12662f6e31ec6b7ea8ac9e8024fa4689a582d6fc21");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // 24x7coin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "24x7coin Signed Message:\n";
...
{
    // 24x7coin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // 24x7coin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // 24x7coin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // 24x7coin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x054b442d8e114a66febb3c12662f6e31ec6b7ea8ac9e8024fa4689a582d6fc21");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1395298704;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085019023;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("24x7coinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("24x7coinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running 24x7coin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("24x7coinMiner terminated\n");
        throw;
    }
}
